...
public class GephiArguments{
    ...
    public Double getLAYOUT_SCALE() {
        return (Double) settings.get("LAYOUT_SCALE");
    }

    public Boolean getBARNES_HUTT_OPTIMIZE() {
        return (Boolean) settings.get("BARNES_HUT_OPTIMIZE");
    }

    public Double getBARNES_HUT_THETA() {
        return (Double) settings.get("BARNES_HUT_THETA");
    }

    public Boolean getSTRONGER_GRAVITY() {
    ...
    public Boolean getADJUST_SIZES() {
    ...
    public Integer getTHREADS_COUNT() {
